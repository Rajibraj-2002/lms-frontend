...
const ManageFines = () => {
    ...
    useEffect(() => {
        ...
        const fetchFines = async () => {
            try {
                const res = await axios.get('https://lms-backend-0jw8.onrender.com/api/admin/fines/all', {
    ...
    const handlePayFine = async (fineId) => {
        try {
            await axios.post(`https://lms-backend-0jw8.onrender.com/api/admin/fines/pay?fineId=${fineId}`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleManualFineSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('https://lms-backend-0jw8.onrender.com/api/admin/fines/add', formData, {
                headers: { Authorization: `Bearer ${token}` }
            });
