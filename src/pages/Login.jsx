...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post('https://lms-backend-0jw8.onrender.com/api/auth/login', formData);
    ...
    const handleResetSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('https://lms-backend-0jw8.onrender.com/api/auth/reset-password', resetData);
